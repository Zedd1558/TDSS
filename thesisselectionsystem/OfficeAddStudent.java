 ...
 * @author DOLPHIN
 */
public class OfficeAddStudent extends javax.swing.JFrame {
   
    
    /**
     * Creates new form OfficeAddingStudent
     */
    public OfficeAddStudent() {
        initComponents();
    ...
    private void initComponents() {
        ...
        cgText = new javax.swing.JTextField();
        ...
        cgText.setBackground(new java.awt.Color(197, 227, 227));
        cgText.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        cgText.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cgTextActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cgText, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(cgText, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jLabel9))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void enterButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enterButtonMousePressed
        ...
        String cgs = cgText.getText();
        
        int id = Integer.parseInt(sid);
        Random random = new Random();
        String pw = String.format("%04d", random.nextInt(10000));
        boolean in = Dbconn.insertStudent(id,pw,name,dept,cgs);
        String st = "Student with ID =" + id + " and password = " + pw + " is added. Send this password to the holder."; 
    ...
    private void cgTextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cgTextActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cgTextActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OfficeAddStudent.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OfficeAddStudent().setVisible(true);
            }
        });
    }

    // Variables declaration - do not modify//GEN-BEGIN:variables
    private javax.swing.JTextField cgText;
