 ...
 * @author DOLPHIN
 */
public class SupervisorLoginFrame extends javax.swing.JFrame {
    public int id;
    /**
    ...
    private void enterButtonMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_enterButtonMousePressed
       ...
       // System.out.println("-" + spw + "-" + "-" + sid + "-");
        String pw = Dbconn.supervisorLogin(id);
        
        if( spw.equals( pw ))
        {
               new SupervisorFrame().show();
        }
        else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SupervisorLoginFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SupervisorLoginFrame().setVisible(true);
            }
        });
    }
